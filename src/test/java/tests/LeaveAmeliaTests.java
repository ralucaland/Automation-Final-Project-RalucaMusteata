...
public class LeaveAmeliaTests extends BaseTests {

    @Test
    public void assignLeaveToEmployeeTest() {

        // Scopul testului:
        // Verificăm că putem asigna concediu unui angajat existent în OrangeHRM.
        // Folosim Amelia Brown ca workaround stabil, deoarece Doru este creat într-un alt test
        // și nu este garantat că există înainte de rularea testului de Leave.

        System.out.println("UI-06 WORKAROUND: Adăugare concediu pentru angajat existent - Amelia Brown");
        ...
        System.out.println("Pasul 6: Introducem numele angajatului existent");
        ...
        System.out.println("TEST TRECUT: Concediul a fost asignat cu succes angajatului existent Amelia Brown.");
    }
}